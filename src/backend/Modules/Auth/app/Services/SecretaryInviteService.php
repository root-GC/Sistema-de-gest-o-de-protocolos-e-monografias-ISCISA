...
class SecretaryInviteService
{
    ...
    public function invite(array $data): User
    {
        $user = DB::transaction(function () use ($data) {
            ...
            if (! $roleId) throw new \RuntimeException("Role 'secretary' não encontrada — corre o RoleSeeder.");
            ...
            $user->secretaryProfile()->create([
                'organ_id'           => $data['organ_id'], // imposto pelo controller, nunca do request
        ...
        try {
            ...
            Log::error('[SecretaryInviteService] falha ao enviar email de acesso', ['email' => $user->email, 'error' => $e->getMessage()]);
