{{-- Modules/Organization/resources/views/emails/reviewer-role-updated.blade.php --}}
<!DOCTYPE html>
<html lang="pt">
<head>
    <meta charset="utf-8">
    <title>Atualização de Função</title>
</head>
        ...
        <tr>
            <td>
                ...
                <p style="color:#333;font-size:15px;">
                    A sua função no órgão abaixo foi <strong>atualizada</strong>:
                </p>
                ...
                <div style="background:#f0f2f5;border-radius:6px;padding:16px;margin:16px 0;">
                    ...
                    <p style="margin:0 0 4px;font-size:13px;color:#666;">Nova Função</p>
                    <p style="margin:0;font-size:14px;color:#006933;font-weight:bold;">{{ $role }}</p>
                </div>
