{{-- Modules/Protocols/resources/views/emails/new-protocol.blade.php --}}
<!DOCTYPE html>
<html lang="pt">
<head>
    <meta charset="utf-8">
    <title>Novo protocolo submetido</title>
</head>
        ...
        <tr>
            <td>
                ...
                <p style="color:#333;font-size:15px;">
                    O seu supervisionado <strong>{{ $studentName }}</strong> submeteu um novo protocolo para a sua aprovacao:
                </p>
                <div style="background:#f0f2f5;border-radius:6px;padding:16px;margin:16px 0;">
                    ...
                    <p style="margin:0 0 12px;font-size:16px;color:#1a1a1a;font-weight:bold;">{{ $protocolCode }}</p>
