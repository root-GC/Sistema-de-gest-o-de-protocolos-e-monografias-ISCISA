{{-- Modules/Auth/resources/views/emails/reset-password.blade.php --}}
<!DOCTYPE html>
<html lang="pt">
<head>
    <meta charset="utf-8">
    <title>Redefinição de Palavra-passe — SGPMC</title>
</head>
        ...
        <tr>
            <td>
                ...
                <p style="color:#333;font-size:15px;">
                    Recebemos um pedido de redefinição da sua palavra-passe.
                </p>
