...
//   footer, footerIcon, footerIconColor, borderHover 
// }: {
//   icon: string
//   iconBg: string
//   iconColor: string
...
//             color: badgeColor,
//             padding: '2px 8px',
//             background: badgeColor ? `${badgeColor}0D` : 'transparent',
...
//             fontSize: '14px',
//             marginRight: '4px',
//             color: footerIconColor || 'var(--on-surface-variant)'
//           }}
//         >
//           {footerIcon}
//         </span>
...
//             <table className="table" style={{ fontSize: 'var(--body-md)' }}>
//               <thead>
//                 <tr>
...
//                         <p style={{ fontWeight: 'var(--font-bold)', fontSize: 'var(--body-md)', margin: 0 }}>
//                           {row.title}
//                         </p>
//                         <p style={{ fontSize: 'var(--label-md)', color: 'var(--on-surface-variant)', margin: 0 }}>
//                           #{row.id}
//                         </p>
//                       </td>
